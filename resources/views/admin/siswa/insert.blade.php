								...
								<form action="{{route('store.siswa',$k->k_id)}}" method="post" class="form-horizontal" role="form" >
									...
									<div class="form-group">
										...
										<div class="col-xs-12 col-sm-9">
											<input type="text" id="nis" name="nis" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="nisn" name="nisn" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="s_nama" name="s_nama" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
