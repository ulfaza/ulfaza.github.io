				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="#">Edit Penguji Kartu Hijau</a>
							</li>
						</ul><!-- /.breadcrumb -->
					</div>
					...
					<div class="page-content">
						<div class="page-header">
							@foreach($ujikh as $u)
							<h4>
								Edit Penguji Kartu Hijau <br> <br>
							...
							<div class="col-xs-12">
								...
								<form action="{{ route('update.ujikh', [$u->uji_id,$u->ta_id,$u->kh_nama]) }}" method="post" class="form-horizontal" role="form" >
									...
									<div class="form-group">
										<label class="control-label col-xs-12 col-sm-3 no-padding-right"> Penguji Mukim </label>
									...
									<div class="form-group">
										<label class="control-label col-xs-12 col-sm-3 no-padding-right"> Penguji Laju </label>

										<div class="col-xs-12 col-sm-9">
											<select  id="penguji_laju" name="penguji_laju" class="select2" >
												<option>{{ $u->penguji_laju }}</option>
												@foreach($guru as $g)
												<option value="{{ $g->nama }}">{{ $g->nama }}</option>
												@endforeach
											</select>
